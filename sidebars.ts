  ...
  tutorialSidebar: [
    {
      ...
      items: [
        ...
        {
          type: 'link',
          label: 'Self-host Youtrack', 
          href: 'https://developers.getyoutrack.io/self-hosting/overview',
        },  
    ...
    },
    {
      ...
      label: 'Importers',
      items: [
        'youtrack-importers/github-imp',
        'youtrack-importers/jira-imp',
      ],
    },
    {
      type: 'category',
      ...
      label: 'Integrations',
      items: [
        'youtrack-integrations/about',
        'youtrack-integrations/github',
        'youtrack-integrations/slack',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      type: 'link',
      label: 'API Reference',
      href: 'https://developers.getyoutrack.io/api-reference/introduction', 
    },
    {
      type: 'link',
      label: 'Webhooks',
      href: 'https://developers.getyoutrack.io/webhooks/intro-webhooks', 
    },
  ], 
};
