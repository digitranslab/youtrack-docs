...
This page will walk you through the core concepts in Youtrack, so you can get familiar with the basics and start navigating your workspace like a pro.

## Workspaces
Think of a workspace as the central hub for everything you do on Youtrack. It’s the top-level space where all your projects and issues live. Workspaces are typically set up for a team, department, or company, and everyone within a workspace can collaborate on projects and access shared resources. You can also think of each workspace as a different organization or client you're working with, keeping things separate and organized.
...
----
With these core concepts under your belt, you’re ready to start exploring Youtrack and putting it to work for your team. Each feature is designed to help you and your team stay organized, collaborate effectively, and deliver your projects with ease.

Have questions? Ask the [Youtrack Community](https://discord.com/invite/29tPNhaV).