...
:::tip
If you are on the Community edition and want to upgrade to the Enterprise edition, see [Upgrade from Community](https://developers.getyoutrack.io/self-hosting/upgrade-from-community).
:::
...
1. On the Youtrack app, click the **⌄** icon next to your workspace name on the sidebar and select **Workspace Settings**.
...
2. Select **Billing and plans** under **Settings**.
   ![Billings and plans](https://media.docs.getyoutrack.io/activate-license/billing-and-plans-cloud.webp#center)
...
6. If your transaction goes through, you will see a confirmation as shown below.  
   ![Plan activated confirmation](https://media.docs.getyoutrack.io/activate-license/activate-pro-license.webp#center)
7. That's it. To check your plan at any time and find additional details, just go to the **Billing and plans** tab in **Workspace Settings**.
    ![Manage subscription](https://media.docs.getyoutrack.io/activate-license/pro-activated-cloud.webp#center)
...
## Self-hosted only
   ...
   1. If your payment goes through, you will be redirected to the [Prime portal](https://prime.getyoutrack.io/licenses), your one-stop interface to manage your licenses and buy new ones.
      :::warning
   ...
   2. Find the license by the plan you just subscribed to. Copy the **License key** for the license you want to activate. 
      ![Manage licenses](https://media.docs.getyoutrack.io/activate-license/copy-license-key.webp#center)
      :::note
      Click the Get more licenses button as in the image above on the [Prime portal](https://prime.getyoutrack.io/licenses/plans) to buy more licenses.
      :::
   3. Go back to the **Billing and plans** screen, usually already open in your browser.
   4. Click the **Activate this Workspace** button.
      ![Activate workspace](https://media.docs.getyoutrack.io/activate-license/enter-license-key-selfhosted.webp#center)
...
### Manage paid users
   ...
   2. You’ll see a **Manage Seats** button. 
         ![Manage seats](https://media.docs.getyoutrack.io/activate-license/manage-seats.webp#center)
      ...
      If you need more seats, click **Add seats**. A modal will appear where you can specify the number of additional paid seats you want to add. Once you’ve entered the number, click **Change**. You’ll be redirected to the Stripe payment portal to complete the payment for the new seats.
         ...
         ![Add seats](https://media.docs.getyoutrack.io/activate-license/add-paid-seats.webp#center)
...
2. Click **Delink license key**. This will release the license key, making it available for use on another machine or workspace.
   ![Delink license key](https://media.docs.getyoutrack.io/activate-license/delink-license-key.webp#center)
3. Restart the instance using `prime-cli restart`.   
4. If you’re switching machines or reinstalling the Commercial edition, see [Move Youtrack instance to another server](https://developers.getyoutrack.io/self-hosting/manage/migrate-youtrack).
