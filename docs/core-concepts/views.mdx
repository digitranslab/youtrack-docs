...
![view](https://media.docs.getyoutrack.io/views/views-overview.webp#center)
## View types

In Youtrack, you can create two different types of views:
...
![Create view](https://media.docs.getyoutrack.io/views/create-view-modal.webp#center)
...
![Create view from existing](https://media.docs.getyoutrack.io/views/view-create-from-existing.webp#center)
...
Views created in a workspace are only visualized with the spreadsheet layout, while project views have access to all layouts. You can learn more about the layouts and grouping options [here](/core-concepts/issues/layouts).
