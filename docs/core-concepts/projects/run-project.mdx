...
Youtrack provides five sets of state groups to categorize all your project states:

- **Backlog**: Useful for issues not yet prioritized by project members. Issues in this group require more work or discussions before they move forward. Youtrack creates a default state in this group called "Backlog".
- **Unstarted**: Useful for issues planned to be picked up by project members. Issues in this state represent upcoming work for members. Youtrack creates a default state called "To-do" in this group.
- **Started**: Useful for issues picked up by project members. Issues in this state represent work that is currently happening in your project. Youtrack creates a default state called "In-progress" in this group.
- **Completed**: Issues in this state represent completed work in your project. Youtrack creates a default state called "Done" in this group.
- **Cancelled**: Issues in this state represent cancelled work in your project. Youtrack creates a default state called "Cancelled" in this group.

![Project state](https://media.docs.getyoutrack.io/projects/issue-states.webp#center)
...
![Project state](https://media.docs.getyoutrack.io/projects/project-new-state.webp#center)
