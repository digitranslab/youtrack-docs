...
![Timeline dependencies](https://media.docs.getyoutrack.io/issues/timeline-dependencies.webp#center)

:::tip
When you drag tasks along the timeline, dependent tasks will adjust automatically to stay in sync.
:::

Youtrack supports three main types of dependencies:
...
- **Finish-to-Start (FS)**   
  ...
  ![Finish to start](https://media.docs.getyoutrack.io/issues/finish-to-start.webp#center)
...
- **Start-to-Start (SS)**  
  ...
  ![Start to start](https://media.docs.getyoutrack.io/issues/start-to-start.webp#center)
...
- **Finish-to-Finish (FF)**  
  ...
  ![Finish to finish](https://media.docs.getyoutrack.io/issues/finish-to-finish.webp#center)
...
![Dependency relations](https://media.docs.getyoutrack.io/issues/dependency-relations.webp#center)
