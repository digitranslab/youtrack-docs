...
In Youtrack, an issue serves as the fundamental unit of work. They represent the tasks you need to accomplish to make progress Think of issues as the to-dos of your project management flow—assignable, trackable, and actionable.
...
![Create issue](https://media.docs.getyoutrack.io/issues/create-issue-modal.webp#center)
...
When you create an issue, Youtrack assigns it a sequential identifier based on your project (e.g., PROJ-1).

:::tip
Youtrack automatically saves your half-written issues so you can access them later in [Drafts](/core-concepts/drafts), in case you're not ready to finalize them or if you accidentally close the modal.
:::

### Quick add issues

For when you're in the middle of your workflow and need to jot something down fast, Youtrack lets you create an issue with minimal input and come back to refine it later.

![Quick add issue](https://media.docs.getyoutrack.io/issues/issue-quick-add.webp#center)
...
![issue-side-peek](https://media.docs.getyoutrack.io/issues/issue-side-peek.webp#center)
...
![sub-issues](https://media.docs.getyoutrack.io/issues/issue-sub-issues.webp#center)
...
![Issue relations](https://media.docs.getyoutrack.io/issues/issue-relations.webp#center)
...
You can easily add links and upload attachments to issues in Youtrack to provide additional context or resources.

![Add links and attachments](https://media.docs.getyoutrack.io/issues/links-and-attachments.webp#center)
...
Youtrack allows you to upload different file types directly to the issue. Whether it’s an image, video, PDF, or a zip file, use the **Attach** button to upload it.
...
![issue-activity-comments](https://media.docs.getyoutrack.io/issues/issue-activity-comments.webp#center)
...
![archived-issues](https://media.docs.getyoutrack.io/issues/archived-issues.webp#center)
...
![Project archive automation](https://media.docs.getyoutrack.io/projects/auto-archive-closed-issues.webp#center)
...
![Project close automation](https://media.docs.getyoutrack.io/projects/auto-close-issues.webp#center)
