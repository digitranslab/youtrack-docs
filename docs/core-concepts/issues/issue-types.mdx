...
Issue Types unlock a whole new way of adding, editing, and moving work forward in Youtrack. The default issue type called `Issue` is great for starting with Youtrack, but as you advance in your project management journey, you find the need for names and properties unique to the type of work you are doing.
...
:::warning 
The Issue Types feature cannot be disabled once enabled for a Youtrack project.
:::
...
![Enable issue type](https://media.docs.getyoutrack.io/issues/enable-issue-types.webp#center)
4. The default type is called `Issue`. Click the **Add Issue Type** button to create a new issue type.
![Add issue type](https://media.docs.getyoutrack.io/issues/add-issue-type.webp#center)
...
![Create issue type](https://media.docs.getyoutrack.io/issues/create-issue-type.webp#center)
6. Switch on the toggle button to allow users to select the issue type when creating issues and sub-issues.
![Activate issue type](https://media.docs.getyoutrack.io/issues/activate-issue-type.webp#center)
...
![Add new property](https://media.docs.getyoutrack.io/issues/add-new-property.webp#center)
2. Specify values for **Title**, **Description** and **Property type** of the new property. 
  ![Property details](https://media.docs.getyoutrack.io/issues/property-details.webp#center)
...
Here's a list of all the property types and attributes that Youtrack provides for creating custom fields:
...
![Use issue types](https://media.docs.getyoutrack.io/issues/use-issue-type.webp#center)
...
2. Hover over to the right of the issue ID and click **Switch issue type**. Alternatively, you can click **Edit** from the issue's ellipsis (•••) menu to open the **Update issue** modal directly.
  ![Switch issue type](https://media.docs.getyoutrack.io/issues/switch-issue-type.webp#center)
3. Choose the new issue type from the dropdown next to your project name.
    ![Update issue type](https://media.docs.getyoutrack.io/issues/update-issue-type.webp#center)
...
3. At the bottom of your screen, open the **Issue type** dropdown and pick the new issue type.
    ![Bulk update issue types](https://media.docs.getyoutrack.io/issues/bulk-update-issue-types.webp#center)
...
2. Toggle off the switch next to the issue type you want to disable.
    ![Disable issue types](https://media.docs.getyoutrack.io/issues/disable-issue-types.webp#center)
