...
Intake is a Youtrack-only feature that lets `Guests` create issues following which `Admins` and `Members` can move these issues inside a project. Intake can take bug reports, feature or service requests, or raise a ticket by stakeholders, customers, or clients. Issues created in Intake can then be accepted to move them to the Project’s workflow.
...
3. Switch on the toggle button for the **Intake** feature to enable it on the project. 
    ...
    ![enable-intake-feature](https://media.docs.getyoutrack.io/intake/enable-intake-feature.webp#center)
...
![create-issue-intake](https://media.docs.getyoutrack.io/intake/create-issue-intake.webp#center)
3. Enter the required details and click the **Create Issue** button.

    ![enter-issue-details](https://media.docs.getyoutrack.io/intake/enter-issue-details.webp#center)
...
### Accept issue
    ...
    ![accept-intake-issue](https://media.docs.getyoutrack.io/intake/accept-intake-issue.webp#center)
...
An issue can be snoozed to review it at a later time.
    ...
    ![snooze-intake-issue](https://media.docs.getyoutrack.io/intake/snooze-intake-issue.webp#center)
...
4. Select an issue in the project that is a duplicate of the Intake issue.
    ...
    ![mark-duplicate-intake-issues](https://media.docs.getyoutrack.io/intake/mark-duplicate-intake-issues.webp#center)
...
You can view **Open** and **Closed** issues in Intake by clicking on the appropriate tabs.
    ...
    <img src="https://media.docs.getyoutrack.io/intake/intake-tabs.webp#center" />
...
- Intake issue description has a rich text editor that allows you to format text, attach pictures, links and files, or add tables and dividers.
        ...
        <img src="https://media.docs.getyoutrack.io/intake/intake-description-box.webp#center" />
...
- Intake has an activity and comments section to know the status and see feedback from users and customers. All the changes made to the issue can be tracked in real-time under the **Activity** section.
        ...
        <img src="https://media.docs.getyoutrack.io/intake/intake-activity.webp#center" />
    
- The **Add Comment** box has a rich text editor where you can react with emojis and mention your teammates to communicate.
    
        <img src="https://media.docs.getyoutrack.io/intake/RTE-reactions-and-mentions.webp#center" />
    
- You can review pending requests in Intake sequentially using 🔼 or 🔽 button.
    
        <img src="https://media.docs.getyoutrack.io/intake/intake-navigate.webp#center" />
